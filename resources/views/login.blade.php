    ...
    <div class="container h-100 pt-5">
      <div class="row h-100 align-items-center justify-content-center">
          <div class="col-md-6">
              ...
              <form autocomplete="off" action="{{ route('loginMatch') }}" class="form">
                  @csrf
                  ...
                  <div class="field">
                      ...
                      <input autocomplete="off" name="email" placeholder="UserEmail"
                          class="input-field bg-transparent" type="email">
                  </div>
                  <div class="field">
                      <svg class="input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                          fill="currentColor" viewBox="0 0 16 16">
                  ...
                  <div class="btn flex-column">
                      <button
                          class="button1 mb-3 w-100">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Login&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
