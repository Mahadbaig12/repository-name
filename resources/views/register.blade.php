...
<form action="{{ route('registerSave') }}" class="form">
  @csrf
    ...
    <div class="field">
      ...
      <input autocomplete="off" name="name" placeholder="Username" class="input-field bg-transparent" type="text">
    </div>
    <div class="field">
    ...
    <path d="M8 1a2 2 0 0 1 2 2v4H6V3a2 2 0 0 1 2-2zm3 6V3a3 3 0 0 0-6 0v4a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z"></path>
      ...
      <input placeholder="Password" name="password" class="input-field bg-transparent" type="password">
    </div>
    <div class="field">
    <svg class="input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
    <path d="M8 1a2 2 0 0 1 2 2v4H6V3a2 2 0 0 1 2-2zm3 6V3a3 3 0 0 0-6 0v4a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z"></path>
    </svg>
      <input placeholder="Confirm Password" name="password_confirmation" class="input-field bg-transparent" type="password">
    </div>
    <div class="btn flex-column">
      <button class="button1 mb-3 w-100">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sign up&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
