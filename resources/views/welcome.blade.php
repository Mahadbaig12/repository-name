                 ...
                 <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item">
                        <div class="service-inner pb-5">
                               @if ($card->photo)
           <img class="img-fluid w-100" style="height: 200px" src="{{ asset('storage/' . $card->photo) }}" alt="{{ $card->name }}" >
       @endif
                            ...
                            <a href="{{ route('view.person', ['id' => $card->id]) }}" class="btn btn-light px-3" href="">Read More<i
